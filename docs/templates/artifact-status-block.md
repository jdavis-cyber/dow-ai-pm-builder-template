...
| Approved | Accepted by PM/PO sign-off |
...
A file's existence is not approval. An artifact is approved only when the relevant approval section or gate package says so.
